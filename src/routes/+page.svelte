<div class="container h-full mx-auto flex justify-center items-center pt-0 mt-[-280px]">
    <div class="space-y-10 text-center flex flex-col items-center">
        <h2 class="h2">HealthScope</h2>
        <!-- Animated Logo -->
        <figure>
            <section class="img-bg" />
			<img src="Untitled-design-2--unscreen.gif" alt="Feature 1" class="rounded-lg shadow-lg large-slow-img no-outline">
            <!-- <svg
...
<div class="container mx-auto py-10 mt-[-280px]">
    <div class="space-y-10">
        <!-- Key Feature 1 -->
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/4 p-4">
                <img src="image.png" alt="Feature 1" class="rounded-lg shadow-lg">
            </div>
            <div class="md:w-3/4 p-4">
                <h3 class="text-2xl font-semibold mb-4">AI Analyzer</h3>
                <p class="text-lg">
                    The AI analyzer analyzes the water quality of water in New York City and provide data on how pure the water is and how healthy it is. It takes in input like pH, hardness, solids, chloramines, and sulfates and explores the real time data in New York City, to give accurate predictions about the water purity.
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/4 p-4">
                <img src="map.png" alt="Feature 2" class="rounded-lg shadow-lg">
            </div>
            <div class="md:w-3/4 p-4">
                <h3 class="text-2xl font-semibold mb-4">Community Outbreaks</h3>
                <p class="text-lg">
                    The Community outbreaks sections gives information about the community outbreaks in New York City. It shows the location of the outbreaks on a map and gives information about them and where they are located in that city based on data.
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/4 p-4">
                <img src="/alerts.png" alt="Feature 3" class="rounded-lg shadow-lg">
            </div>
            <div class="md:w-3/4 p-4">
                <h3 class="text-2xl font-semibold mb-4">Alerts</h3>
                <p class="text-lg">
                   The alerts section gives information about the problems of diseases in New York City. It uses the infromation from the community outbreaks and gives alerts so you are aware of any poor quality water. If there is poor water, you can always check with our AI Analyzer!
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/4 p-4">
                <img src="suggestions.png" alt="Feature 4" class="rounded-lg shadow-lg">
            </div>
            <div class="md:w-3/4 p-4">
                <h3 class="text-2xl font-semibold mb-4">Suggestions</h3>
                <p class="text-lg">
                    The Suggestions sections gives suggestions on how to improve the water quality and how you can take the right protocals to prevent yourself from any waterborne diseases.
                </p>
            </div>
        </div>
    </div>
...
<style lang="postcss">
    ...
    .img-bg {
		...
		left: 20%; /* Adjust this value to move the glow to the right */
}

	.large-slow-img {
        width: 1000000%; /* Makes the image 2x larger */
        height: auto; /* Maintains aspect ratio */
        animation: slow-animation 5s infinite; /* Slow down the animation */
